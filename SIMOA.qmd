...
## Below the code will print the results rather than having to look through the 
## objects. However, all of these values will be in the environment and I will
## not code over previous objects. But printing the information makes it easier
## to find. 
print(AGE_mean)
print(AGE_sd)
cat("N =", AGE_N, "\n")
